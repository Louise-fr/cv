...
var _from = 'cv.fresquet@gmail.com';
var _dates = '';

//Email parameters for user
var _user_to = 'l.fresq.g@gmail.com';
var _user_subject = 'Message bien reçu';
var _user_message = '';
...
var _admin_subject = 'Un visiteur a envoyé un mail depuis CV Portfolio';
...
function setUserEmailParameters (email, name) {
  _user_to = email
  _user_name = name
}
...
function setAdminEmailParameters (message, subject) {
...
function setUserEmailContent (){
  fs.readFile(USER_EMAIL_TEMPLATE_PATH, 'utf8', function (err,data) {
    ...
    var result = data.replace(/\_nom\_/gi, _user_name);
...
module.exports.gapiSendMessages = function(subject, message, email, name){
  //Preparing emails for user and admin
  // console.log(subject)
  // console.log(message)
  // console.log(email)
  // console.log(name)
  setUserEmailParameters(email, name)
  setAdminEmailParameters(message, subject)
  setUserEmailContent()
